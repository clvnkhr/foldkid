...
//#region node_modules/effect/dist/Equivalence.js
/**
...
* @since 2.0.0
*/
var Equivalence_exports = /* @__PURE__ */ __exportAll({
	Array: () => Array_,
	BigInt: () => BigInt,
	Boolean: () => Boolean,
	Date: () => Date,
...
* @since 4.0.0
*/
var Number = /*#__PURE__*/ make((self, that) => globalThis.Number.isNaN(self) && globalThis.Number.isNaN(that));
/**
...
* @since 4.0.0
*/
var Boolean = isStrictEquivalent;
/**
...
* @since 2.0.0
*/
var combineAll = (collection) => make((x, y) => {
	for (const equivalence of collection) if (!equivalence(x, y)) return false;
	return true;
});
/**
...
function Record(value) {
	return make((self, that) => {
		...
		for (const key of selfKeys) if (!Object.hasOwn(that, key) || !value(self[key], that[key])) return false;
		return true;
	});
}
/**
...
function makeReducer() {
	return make$1(combine, () => true, combineAll);
}
/**
...
* @since 4.0.0
*/
var Date = /*#__PURE__*/ mapInput(Number, (d) => d.getTime());
//#endregion
export { Array_ as Array, BigInt, Boolean, Date, Number, Record, String, Struct, Tuple, combine, combineAll, make, makeReducer, mapInput, strictEqual, Equivalence_exports as t };

//# sourceMappingURL=effect_Equivalence.js.map