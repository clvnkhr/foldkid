...
import { _ as identity, c as constNull, p as dual, u as constUndefined } from "./Function-CAyx_go8.js";
import { isFunction } from "./effect_Predicate.js";
import { make } from "./effect_Equivalence.js";
import { a as isFailure$1, c as succeed$1, f as none, g as let_$1, h as bindTo$1, i as getSuccess$1, l as isNone, m as bind$1, n as fromOption$1, o as isResult$1, p as some, r as getFailure$1, s as isSuccess$1, t as fail$1 } from "./result-C2ZxmjWl.js";
//#region node_modules/effect/dist/Result.js
/**
...
* @since 4.0.0
*/
var failVoid = /*#__PURE__*/ fail(void 0);
/**
...
* @since 4.0.0
*/
var fromNullishOr = /*#__PURE__*/ dual(2, (self, onNullish) => self == null ? fail(onNullish(self)) : succeed(self));
/**
...
* @since 4.0.0
*/
var makeEquivalence = (success, failure) => make((x, y) => isFailure(x) ? isFailure(y) && failure(x.failure, y.failure) : isSuccess(y) && success(x.success, y.success));
/**
...
* @since 4.0.0
*/
var mapBoth = /*#__PURE__*/ dual(2, (self, { onFailure, onSuccess }) => isFailure(self) ? fail(onFailure(self.failure)) : succeed(onSuccess(self.success)));
/**
...
* @since 4.0.0
*/
var mapError = /*#__PURE__*/ dual(2, (self, f) => isFailure(self) ? fail(f(self.failure)) : succeed(self.success));
/**
...
* @since 4.0.0
*/
var map = /*#__PURE__*/ dual(2, (self, f) => isSuccess(self) ? succeed(f(self.success)) : fail(self.failure));
/**
...
* @since 4.0.0
*/
var match = /*#__PURE__*/ dual(2, (self, { onFailure, onSuccess }) => isFailure(self) ? onFailure(self.failure) : onSuccess(self.success));
/**
...
* @since 4.0.0
*/
var liftPredicate = /*#__PURE__*/ dual(3, (a, predicate, orFailWith) => predicate(a) ? succeed(a) : fail(orFailWith(a)));
/**
...
* @category Filtering
*/
var filterOrFail = /*#__PURE__*/ dual(3, (self, predicate, orFailWith) => flatMap(self, (a) => predicate(a) ? succeed(a) : fail(orFailWith(a))));
/**
...
* @since 4.0.0
*/
var getOrElse = /*#__PURE__*/ dual(2, (self, onFailure) => isFailure(self) ? onFailure(self.failure) : self.success);
/**
...
var getOrThrowWith = /*#__PURE__*/ dual(2, (self, onFailure) => {
	if (isSuccess(self)) return self.success;
...
* @since 4.0.0
*/
var orElse = /*#__PURE__*/ dual(2, (self, that) => isFailure(self) ? that(self.failure) : succeed(self.success));
/**
...
* @since 4.0.0
*/
var flatMap = /*#__PURE__*/ dual(2, (self, f) => isFailure(self) ? fail(self.failure) : f(self.success));
/**
...
* @since 4.0.0
*/
var flip = (self) => isFailure(self) ? succeed(self.failure) : fail(self.success);
/**
...
*/
var gen = (...args) => {
	const iterator = (args.length === 1 ? args[0] : args[1].bind(args[0]))();
...
var transposeOption = (self) => {
	return isNone(self) ? succeedNone : map(self.value, some);
};
/**
...
* @category Transposing
*/
var transposeMapOption = /*#__PURE__*/ dual(2, (self, f) => isNone(self) ? succeedNone : map(f(self.value), some));
/**
...
* @since 4.0.0
*/
var succeedNone = /*#__PURE__*/ succeed(none);
/**
...
* @since 4.0.0
*/
var tap = /*#__PURE__*/ dual(2, (self, f) => {
	if (isSuccess(self)) f(self.success);
	return self;
});
//#endregion
export { Do, all, andThen, bind, bindTo, fail, failVoid, filterOrFail, flatMap, flip, fromNullishOr, fromOption, gen, getFailure, getOrElse, getOrNull, getOrThrow, getOrThrowWith, getOrUndefined, getSuccess, isFailure, isResult, isSuccess, let_ as let, liftPredicate, makeEquivalence, map, mapBoth, mapError, match, merge, orElse, succeed, succeedNone, succeedSome, Result_exports as t, tap, transposeMapOption, transposeOption, try_ as try, void_ as void };

//# sourceMappingURL=effect_Result.js.map