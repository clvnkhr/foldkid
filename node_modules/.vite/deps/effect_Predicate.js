...
//#region node_modules/effect/dist/Predicate.js
/**
...
* @since 2.0.0
*/
var Predicate_exports = /* @__PURE__ */ __exportAll({
	Struct: () => Struct,
	Tuple: () => Tuple,
	and: () => and,
	compose: () => compose,
...
function Tuple(elements) {
	return (as) => {
		for (let i = 0; i < elements.length; i++) if (elements[i](as[i]) === false) return false;
		return true;
	};
}
/**
...
function Struct(fields) {
	...
	return (a) => {
		for (const key of keys) if (!fields[key](a[key])) return false;
		return true;
	};
}
/**
...
function every(collection) {
	return (a) => {
		for (const p of collection) if (!p(a)) return false;
		return true;
	};
}
/**
...
function some(collection) {
	return (a) => {
		for (const p of collection) if (p(a)) return true;
		return false;
	};
}
//#endregion
export { Struct, Tuple, and, compose, eqv, every, hasProperty, implies, isBigInt, isBoolean, isDate, isError, isFunction, isIterable, isMap, isNever, isNotNull, isNotNullish, isNotUndefined, isNull, isNullish, isNumber, isObject, isObjectKeyword, isObjectOrArray, isPromise, isPromiseLike, isPropertyKey, isReadonlyObject, isRegExp, isSet, isString, isSymbol, isTagged, isTruthy, isTupleOf, isTupleOfAtLeast, isUint8Array, isUndefined, isUnknown, mapInput, nand, nor, not, or, some, Predicate_exports as t, xor };

//# sourceMappingURL=effect_Predicate.js.map