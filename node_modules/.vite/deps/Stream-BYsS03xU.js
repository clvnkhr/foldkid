...
import { A as unbounded, D as takeAll, E as take$3, M as make$7, N as makeUnsafe$5, T as subscribe, _ as publishAll, c as dropping, g as publish, o as bounded, w as sliding$1, x as shutdown } from "./PubSub-CCYPM6Ux.js";
...
* @category constructors
*/
var make$6 = (permits) => sync$3(() => new SemaphoreImpl(permits));
/**
...
* @since 3.5.4
*/
var isChannel = (u) => hasProperty(u, TypeId$6);
var ChannelProto = {
	[TypeId$6]: {
		_Env: identity$1,
		_InErr: identity$1,
...
* @since 2.0.0
*/
var fromIterable$2 = (iterable) => fromIterator(() => iterable[Symbol.iterator]());
/**
...
* @category constructors
*/
var empty$2 = /*#__PURE__*/ fromPull$1(/*#__PURE__*/ succeed$6(/*#__PURE__*/ done()));
/**
...
var ignore$1 = /*#__PURE__*/ dual((args) => isChannel(args[0]), (self, options) => {
	if (!options?.log) return catch_$2(self, () => empty$2);
	const logEffect = logWithLevel(options.log === true ? void 0 : options.log);
	return catch_$2(tapCause$1(self, (cause) => hasFails(cause) ? logEffect(cause) : void_$2), () => empty$2);
});
var ignoreCause_ = (self) => catchCause$2(self, () => empty$2);
/**
...
var TypeId$4 = "~effect/collections/MutableHashMap";
/**
...
* @since 4.0.0
*/
var isMutableHashMap = (value) => hasProperty(value, TypeId$4);
...
* @category constructors
*/
var make$5 = (...entries) => fromIterable$1(entries);
/**
...
* ```
*/
var make$4 = (options) => withFiber$1((fiber) => {
...
* @category guards
*/
var isSink = (u) => hasProperty(u, TypeId$1);
/**
...
* @category constructors
*/
var make$1 = () => (...fns) => fromTransform((upstream, scope) => pipe(fromChannel$2(fromPull$1(succeed$6(upstream))), ...fns, flatMap$4((a) => done([a])), provide$2(scope)));
/**
* @since 4.0.0
* @category constructors
*/
...
* @category Constructors
*/
var empty = /*#__PURE__*/ fromChannel(empty$2);
/**
...
var groupByImpl = (self, f, options) => transformPullBracket(self, fnUntraced(function* (pull, scope, forkedScope) {
	...
	const queueMap = empty$1();
	const queues = yield* make$4({
...
* @category Broadcast
*/
var share = /*#__PURE__*/ dual(2, (self, options) => map$6(make$2({
...
* @category Pipe
*/
var pipeThrough = /*#__PURE__*/ dual(2, (self, sink) => self.channel.pipe(pipeToOrFail(toChannel$1(sink)), concatWith(([_, leftover]) => leftover ? succeed$2(leftover) : empty$2), fromChannel));
/**
...
//#endregion
export { failSync as $, runIntoPubSub as $n, when as $r, mapAccumEffect as $t, combine as A, has$1 as Ai, prepend as An, throttle as Ar, fromSchedule as At, drop as B, Take_exports as Bi, repeatElements as Bn, toPubSubTake as Br, interleave as Bt, catchTags as C, invalidate$2 as Ci, partition as Cn, takeWhileEffect as Cr, fromIterableEffectRepeat as Ct, changesWithEffect as D, empty$1 as Di, pipeThrough as Dn, tapCause as Dr, fromPull as Dt, changesWith as E, clear as Ei, peel as En, tapBoth as Er, fromPubSubTake as Et, debounce as F, size as Fi, race as Fn, toAsyncIterable as Fr, grouped as Ft, dropWhileEffect as G, runCount as Gn, toReadableStreamWith as Gr, isStream as Gt, dropUntil as H, makeUnsafe$1 as Hi, retry as Hn, toQueue as Hr, interruptWhen as Ht, decodeText as I, values as Ii, raceAll as In, toAsyncIterableEffect as Ir, groupedWithin as It, encodeText as J, runFoldEffect as Jn, transformPullBracket as Jr, make as Jt, dropWhileFilter as K, runDrain as Kn, transduce as Kr, iterate as Kt, die as L, Channel_exports as Li, range as Ln, toAsyncIterableWith as Lr, haltWhen as Lt, concat as M, make$5 as Mi, provideContext as Mn, tick as Mr, groupAdjacentBy as Mt, cross as N, remove as Ni, provideService as Nn, timeout as Nr, groupBy as Nt, chunks as O, fromIterable$1 as Oi, pipeThroughChannel as On, tapError as Or, fromQueue as Ot, crossWith as P, set as Pi, provideServiceEffect as Pn, timeoutOrElse as Pr, groupByKey as Pt, failCauseSync as Q, runHead as Qn, updateService as Qr, mapAccumArrayEffect as Qt, drain as R, fromTransform$1 as Ri, rechunk as Rn, toChannel as Rr, ignore as Rt, catchTag as S, get$2 as Si, paginate as Sn, takeWhile as Sr, fromIterableEffect as St, changes as T, MutableHashMap_exports as Ti, partitionQueue as Tn, tap as Tr, fromPubSub as Tt, dropUntilEffect as U, run as Un, toReadableStream as Ur, intersperse as Ut, dropRight as V, Semaphore_exports as Vi, result as Vn, toPull as Vr, interleaveWith as Vt, dropWhile as W, runCollect as Wn, toReadableStreamEffect as Wr, intersperseAffixes as Wt, fail as X, runForEachArray as Xn, unwrap as Xr, mapAccum as Xt, ensuring as Y, runForEach as Yn, unfold as Yr, map as Yt, failCause as Z, runForEachWhile as Zn, updateContext as Zr, mapAccumArray as Zt, catchCauseIf as _, fail$1 as _i, onFirst as _n, sync as _r, fromEffectDrain as _t, accumulate as a, zipLatestAll as ai, merge as an, schedule as ar, flatten as at, catchReason as b, RcRef_exports as bi, orElseIfEmpty as bn, takeUntil as br, fromEventListener as bt, bind as c, zipRight as ci, mergeLeft as cn, serviceOption as cr, flattenIterable as ct, broadcast as d, zipWithIndex as di, mkString as dn, slidingSize as dr, fromArray as dt, withExecutionPlan as ei, mapArray as en, runIntoQueue as er, filter as et, buffer as f, zipWithNext as fi, mkUint8Array as fn, split as fr, fromArrayEffect as ft, catchCauseFilter as g, drain$1 as gi, onExit as gn, switchMap as gr, fromEffect as gt, catchCause as h, Sink_exports as hi, onError as hn, suspend as hr, fromChannel as ht, TypeId as i, zipLatest as ii, mapError as in, scanEffect as ir, flatMap as it, combineArray as j, keys$1 as ji, provide as jn, throttleEffect as jr, fromSubscription as jt, collect as k, get$3 as ki, pipeThroughChannelOrFail as kn, tapSink as kr, fromReadableStream as kt, bindEffect as l, zipWith as li, mergeResult as ln, share as lr, flattenTake as lt, callback as m, zipWithPreviousAndNext as mi, onEnd as mn, succeed as mr, fromAsyncIterable as mt, Do as n, zip as ni, mapBoth as nn, runSum as nr, filterMap as nt, aggregate as o, zipLatestWith as oi, mergeAll as on, scoped as or, flattenArray as ot, bufferArray as p, zipWithPrevious as pi, never as pn, splitLines as pr, fromArrays as pt, empty as q, runFold as qn, transformPull as qr, let_ as qt, Stream_exports as r, zipFlatten as ri, mapEffect as rn, scan as rr, filterMapEffect as rt, aggregateWithin as s, zipLeft as si, mergeEffect as sn, service as sr, flattenEffect as st, DefaultChunkSize as t, withSpan as ti, mapArrayEffect as tn, runLast as tr, filterEffect as tt, bindTo as u, zipWithArray as ui, mergeRight as un, sliding as ur, forever as ut, catchFilter as v, forEach as vi, onStart as vn, take as vr, fromEffectRepeat as vt, catch_ as w, make$4 as wi, partitionEffect as wn, takeWhileFilter as wr, fromIteratorSucceed as wt, catchReasons as x, RcMap_exports as xi, orElseSucceed as xn, takeUntilEffect as xr, fromIterable as xt, catchIf as y, unwrap$1 as yi, orDie as yn, takeRight as yr, fromEffectSchedule as yt, drainFork as z, pipeTo as zi, repeat as zn, toPubSub as zr, ignoreCause as zt };

//# sourceMappingURL=Stream-BYsS03xU.js.map