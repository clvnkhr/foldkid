...
import { T as pipeArguments, _ as identity, p as dual, y as pipe } from "./Function-CAyx_go8.js";
import { f as symbol, n as array } from "./Hash-BNI6TCCj.js";
import { hasProperty } from "./effect_Predicate.js";
import { equals, symbol as symbol$1 } from "./effect_Equal.js";
import { make as make$1 } from "./effect_Equivalence.js";
import { $ as toJson, Q as NodeInspectSymbol, nt as format } from "./core-CH33zrUT.js";
import { mapInput } from "./effect_Order.js";
import { isSome, map as map$1, none, some as some$1 } from "./effect_Option.js";
import { isSuccess } from "./effect_Result.js";
import { At as mapAccum$1, Cn as unzip$1, En as zipWith$1, Gt as reduce$1, H as fromIterable$1, I as findLast$1, It as modify$1, Kt as reduceRight$1, L as findLastIndex$1, N as findFirst$1, P as findFirstIndex$1, S as differenceWith$1, Tt as makeBy$1, Vt as partition$1, Xt as reverse$1, _ as dedupe$1, bn as union$1, en as separate$1, ht as join$1, in as sort$1, j as filter$1, kt as map$2, m as containsWith$1, ot as intersection$1, p as contains$1, qt as remove$1, v as dedupeAdjacent$1, x as difference$1 } from "./Array-DYbb2clh.js";
//#region node_modules/effect/dist/Chunk.js
/**
...
var TypeId = "~effect/collections/Chunk";
...
* @since 2.0.0
*/
var makeEquivalence = (isEquivalent) => make$1((self, that) => self.length === that.length && toReadonlyArray(self).every((value, i) => isEquivalent(value, getUnsafe(that, i))));
var _equivalence = /*#__PURE__*/ makeEquivalence(equals);
var ChunkProto = {
	[TypeId]: { _A: (_) => _ },
	toString() {
...
* @since 2.0.0
*/
var isChunk = (u) => hasProperty(u, TypeId);
var _empty = /*#__PURE__*/ makeChunk({ _tag: "IEmpty" });
/**
...
* @since 2.0.0
*/
var make = (...as) => fromNonEmptyArrayUnsafe(as);
/**
...
* @since 2.0.0
*/
var fromIterable = (self) => isChunk(self) ? self : fromArrayUnsafe(fromIterable$1(self));
...
var reverseChunk = (self) => {
	switch (self.backing._tag) {
		...
		case "ISlice": return fromArrayUnsafe(reverse$1(toReadonlyArray(self)));
	}
};
/**
...
* @since 2.0.0
*/
var get = /*#__PURE__*/ dual(2, (self, index) => index < 0 || index >= self.length ? none() : some$1(getUnsafe(self, index)));
/**
...
* @category unsafe
*/
var fromArrayUnsafe = (self) => self.length === 0 ? empty() : self.length === 1 ? of(self[0]) : makeChunk({
	_tag: "IArray",
	array: self
});
/**
...
* @category unsafe
*/
var fromNonEmptyArrayUnsafe = (self) => fromArrayUnsafe(self);
/**
...
var getUnsafe = /*#__PURE__*/ dual(2, (self, index) => {
	...
	switch (self.backing._tag) {
		...
		case "ISingleton":
			if (index !== 0) throw new Error(`Index out of bounds: ${i}`);
			return self.backing.a;
		case "IArray":
			if (i >= self.length || i < 0) throw new Error(`Index out of bounds: ${i}`);
			return self.backing.array[i];
		case "IConcat": return i < self.left.length ? getUnsafe(self.left, i) : getUnsafe(self.right, i - self.left.length);
		case "ISlice": return getUnsafe(self.backing.chunk, i + self.backing.offset);
	}
});
/**
...
* @since 2.0.0
*/
var append = /*#__PURE__*/ dual(2, (self, a) => appendAll(self, of(a)));
/**
...
var filterMap = /*#__PURE__*/ dual(2, (self, f) => {
	...
	for (let i = 0; i < as.length; i++) {
		...
		if (isSuccess(result)) out.push(result.success);
	}
...
* @category filtering
*/
var filter = /*#__PURE__*/ dual(2, (self, predicate) => fromArrayUnsafe(filter$1(self, predicate)));
/**
...
var compact = (self) => {
	const out = [];
	for (const option of self) if (isSome(option)) out.push(option.value);
	return fromArrayUnsafe(out);
};
/**
...
var chunksOf = /*#__PURE__*/ dual(2, (self, n) => {
	...
	if (current.length > 0) gr.push(fromArrayUnsafe(current));
...
* @category elements
*/
var intersection = /*#__PURE__*/ dual(2, (self, that) => fromArrayUnsafe(intersection$1(toReadonlyArray(self), toReadonlyArray(that))));
/**
...
* @category unsafe
*/
var headUnsafe = (self) => getUnsafe(self, 0);
/**
...
* @since 2.0.0
*/
var last = (self) => get(self, self.length - 1);
/**
...
* @category unsafe
*/
var lastUnsafe = (self) => getUnsafe(self, self.length - 1);
/**
...
* @category mapping
*/
var map = /*#__PURE__*/ dual(2, (self, f) => self.backing._tag === "ISingleton" ? of(f(self.backing.a, 0)) : fromArrayUnsafe(pipe(toReadonlyArray(self), map$2((a, i) => f(a, i)))));
/**
...
var partition = /*#__PURE__*/ dual(2, (self, f) => {
	const [excluded, satisfying] = partition$1(self, f);
...
* @since 2.0.0
*/
var separate = (self) => pipe(separate$1(toReadonlyArray(self)), ([l, r]) => [fromArrayUnsafe(l), fromArrayUnsafe(r)]);
/**
...
* @category sorting
*/
var sort = /*#__PURE__*/ dual(2, (self, O) => fromArrayUnsafe(sort$1(toReadonlyArray(self), O)));
/**
...
var splitWhere = /*#__PURE__*/ dual(2, (self, predicate) => {
	let i = 0;
	for (const a of toReadonlyArray(self)) if (predicate(a)) break;
	else i++;
...
* @category elements
*/
var tail = (self) => self.length > 0 ? some$1(drop(self, 1)) : none();
/**
* Returns every elements after the first.
*
* @example
...
* @category elements
*/
var takeRight = /*#__PURE__*/ dual(2, (self, n) => drop(self, self.length - n));
/**
...
var takeWhile = /*#__PURE__*/ dual(2, (self, predicate) => {
	const out = [];
	for (const a of toReadonlyArray(self)) if (predicate(a)) out.push(a);
	else break;
	return fromArrayUnsafe(out);
});
/**
...
* @category elements
*/
var union = /*#__PURE__*/ dual(2, (self, that) => fromArrayUnsafe(union$1(toReadonlyArray(self), toReadonlyArray(that))));
/**
...
* @category elements
*/
var dedupe = (self) => fromArrayUnsafe(dedupe$1(toReadonlyArray(self)));
/**
...
* @category filtering
*/
var dedupeAdjacent = (self) => fromArrayUnsafe(dedupeAdjacent$1(self));
/**
...
* @category zipping
*/
var zipWith = /*#__PURE__*/ dual(3, (self, that, f) => fromArrayUnsafe(zipWith$1(self, that, f)));
/**
...
* @since 2.0.0
*/
var remove = /*#__PURE__*/ dual(2, (self, i) => fromArrayUnsafe(remove$1(toReadonlyArray(self), i)));
/**
...
* @since 2.0.0
*/
var modify = /*#__PURE__*/ dual(3, (self, i, f) => pipe(modify$1(toReadonlyArray(self), i, f), map$1(fromArrayUnsafe)));
/**
...
* @since 2.0.0
*/
var makeBy = /*#__PURE__*/ dual(2, (n, f) => fromIterable(makeBy$1(n, f)));
/**
...
* @since 2.0.0
*/
var range = (start, end) => start <= end ? makeBy(end - start + 1, (i) => start + i) : of(start);
/**
...
* @since 2.0.0
*/
var containsWith = containsWith$1;
/**
...
* @since 2.0.0
*/
var findFirstIndex = /*#__PURE__*/ dual(2, (self, predicate) => findFirstIndex$1(self, predicate));
/**
...
* @since 2.0.0
*/
var findLastIndex = /*#__PURE__*/ dual(2, (self, predicate) => findLastIndex$1(self, predicate));
/**
...
* @since 2.0.0
*/
var every = /*#__PURE__*/ dual(2, (self, refinement) => fromIterable$1(self).every(refinement));
/**
...
* @since 2.0.0
*/
var some = /*#__PURE__*/ dual(2, (self, predicate) => fromIterable$1(self).some(predicate));
/**
...
var differenceWith = (isEquivalent) => {
	return dual(2, (self, that) => fromArrayUnsafe(differenceWith$1(isEquivalent)(self, that)));
};
/**
...
* @since 3.2.0
*/
var difference = /*#__PURE__*/ dual(2, (self, that) => fromArrayUnsafe(difference$1(self, that)));
//#endregion
export { take as _, empty as a, head as c, isNonEmpty as d, makeEquivalence as f, size as g, prependAll as h, drop as i, isChunk as l, prepend as m, append as n, filter as o, map as p, appendAll as r, fromIterable as s, Chunk_exports as t, isEmpty as u, toArray as v, toReadonlyArray as y };

//# sourceMappingURL=Chunk-PvjTXp5m.js.map