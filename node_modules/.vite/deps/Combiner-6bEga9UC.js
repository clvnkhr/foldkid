...
//#region node_modules/effect/dist/Combiner.js
var Combiner_exports = /* @__PURE__ */ __exportAll({
	constant: () => constant,
	first: () => first,
	flip: () => flip,
...
* @since 4.0.0
*/
function intercalate(middle) {
	return (combiner) => make((self, that) => combiner.combine(self, combiner.combine(middle, that)));
}
//#endregion
export { min as i, make as n, max as r, Combiner_exports as t };

//# sourceMappingURL=Combiner-6bEga9UC.js.map