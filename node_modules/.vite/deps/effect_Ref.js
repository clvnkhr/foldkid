...
import { hr as sync } from "./Effect-X-nh5NFG.js";
import { i as set$1, r as make$1 } from "./MutableRef-0h-dUBFH.js";
//#region node_modules/effect/dist/Ref.js
/**
...
var getAndUpdateSome = /*#__PURE__*/ dual(2, (self, pf) => sync(() => {
	...
	if (option._tag === "Some") self.ref.current = option.value;
	return current;
}));
/**
...
//#endregion
export { get, getAndSet, getAndUpdate, getAndUpdateSome, getUnsafe, make, makeUnsafe, modify, modifySome, set, setAndGet, Ref_exports as t, update, updateAndGet, updateSome, updateSomeAndGet };

//# sourceMappingURL=effect_Ref.js.map