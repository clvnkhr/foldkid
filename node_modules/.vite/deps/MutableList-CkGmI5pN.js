...
import { H as fromIterable } from "./Array-DYbb2clh.js";
//#region node_modules/effect/dist/MutableList.js
/**
* @fileoverview
...
*/
var MutableList_exports = /* @__PURE__ */ __exportAll({
	Empty: () => Empty,
	append: () => append,
	appendAll: () => appendAll,
	appendAllUnsafe: () => appendAllUnsafe,
	clear: () => clear,
	filter: () => filter,
	make: () => make,
	prepend: () => prepend,
	prependAll: () => prependAll,
	prependAllUnsafe: () => prependAllUnsafe,
	remove: () => remove,
	take: () => take,
	takeAll: () => takeAll,
	takeN: () => takeN,
...
* @category mutations
*/
var prependAll = (self, messages) => prependAllUnsafe(self, fromIterable(messages), !Array.isArray(messages));
/**
...
* @category mutations
*/
var prependAllUnsafe = (self, messages, mutable = false) => {
	self.head = {
		array: messages,
		mutable,
		offset: 0,
...
* @category mutations
*/
var appendAll = (self, messages) => appendAllUnsafe(self, fromIterable(messages), !Array.isArray(messages));
/**
...
* @category elements
*/
var toArray = (self) => toArrayN(self, self.length);
/**
...
var filter = (self, f) => {
	...
	let chunk = self.head;
	while (chunk) {
		for (let i = chunk.offset; i < chunk.array.length; i++) if (f(chunk.array[i], i)) array.push(chunk.array[i]);
		chunk = chunk.next;
	}
	self.head = self.tail = {
		array,
...
* @category mutations
*/
var remove = (self, value) => filter(self, (v) => v !== value);
//#endregion
export { appendAllUnsafe as a, make as c, take as d, takeAll as f, toArrayN as h, appendAll as i, prepend as l, takeNVoid as m, MutableList_exports as n, clear as o, takeN as p, append as r, filter as s, Empty as t, remove as u };

//# sourceMappingURL=MutableList-CkGmI5pN.js.map