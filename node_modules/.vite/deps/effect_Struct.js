...
import { Struct } from "./effect_Equivalence.js";
import { n as make$1 } from "./Combiner-6bEga9UC.js";
import { Struct as Struct$1 } from "./effect_Order.js";
//#region node_modules/effect/dist/Struct.js
/**
...
* @since 2.0.0
*/
var Struct_exports = /* @__PURE__ */ __exportAll({
	Record: () => Record,
	assign: () => assign,
	evolve: () => evolve,
...
* @since 2.0.0
*/
var get = /*#__PURE__*/ dual(2, (self, key) => self[key]);
/**
...
* @since 4.0.0
*/
var map = /*#__PURE__*/ dual(2, (self, lambda) => {
...
* @since 4.0.0
*/
var mapPick = /*#__PURE__*/ dual(3, (self, keys, lambda) => {
...
* @since 4.0.0
*/
var mapOmit = /*#__PURE__*/ dual(3, (self, keys, lambda) => {
	return buildStruct(self, (k, v) => [k, !keys.includes(k) ? lambda(v) : v]);
});
/**
...
* @since 4.0.0
*/
function makeReducer(reducers, options) {
	...
	return make(combine, initialValue);
}
/**
...
//#endregion
export { Record, assign, evolve, evolveEntries, evolveKeys, get, keys, lambda, makeCombiner, makeEquivalence, makeOrder, makeReducer, map, mapOmit, mapPick, omit, pick, renameKeys, Struct_exports as t };

//# sourceMappingURL=effect_Struct.js.map