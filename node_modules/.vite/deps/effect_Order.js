...
//#region node_modules/effect/dist/Order.js
/**
...
* @since 4.0.0
*/
var String = /*#__PURE__*/ make((self, that) => self < that ? -1 : 1);
/**
...
* @since 4.0.0
*/
var Number = /*#__PURE__*/ make((self, that) => {
...
* @since 4.0.0
*/
var Boolean = /*#__PURE__*/ make((self, that) => self < that ? -1 : 1);
/**
...
* @since 4.0.0
*/
var BigInt = /*#__PURE__*/ make((self, that) => self < that ? -1 : 1);
/**
...
* @since 2.0.0
*/
var combine = /*#__PURE__*/ dual(2, (self, that) => make((a1, a2) => {
...
* @since 2.0.0
*/
var Date = /*#__PURE__*/ mapInput(Number, (date) => date.getTime());
/**
...
function makeReducer() {
	return make$1(combine, () => 0, combineAll);
}
//#endregion
export { Array_ as Array, BigInt, Boolean, Date, Number, String, Struct, Tuple, alwaysEqual, clamp, combine, combineAll, flip, isBetween, isGreaterThan, isGreaterThanOrEqualTo, isLessThan, isLessThanOrEqualTo, make, makeReducer, mapInput, max, min, Order_exports as t };

//# sourceMappingURL=effect_Order.js.map