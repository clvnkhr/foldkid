...
//#region node_modules/effect/dist/Reducer.js
var Reducer_exports = /* @__PURE__ */ __exportAll({
	flip: () => flip,
	make: () => make
});
/**
...
* @since 4.0.0
*/
function make(combine, initialValue, combineAll) {
	return {
		combine,
		initialValue,
...
* @since 4.0.0
*/
function flip(reducer) {
	return make((self, that) => reducer.combine(that, self), reducer.initialValue);
}
//#endregion
export { make as n, Reducer_exports as t };

//# sourceMappingURL=Reducer-Cm_A1Upl.js.map